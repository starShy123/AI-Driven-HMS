      ...
      >
        ...
        <div className="p-4 border-t border-gray-200 space-y-2">
          ...
          >
            ...
            <span className="text-sm font-medium">{t.language}: {language === 'EN' ? 'English' : 'বাংলা'}</span>
          </button>
          ...
          <div className="flex items-center justify-between px-4 py-4 sm:px-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900">
                  {currentNavigation.find(item => item.id === currentView)?.label || t.dashboard}
                </h2>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                <span className="text-sm font-medium hidden sm:inline">{t.emergency}</span>
              </button>
