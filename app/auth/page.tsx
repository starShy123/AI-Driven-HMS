...
export default function AuthPage() {
  ...
  const texts = {
    EN: {
      ...
      appDescription:
        "AI-powered healthcare access platform for rural & hill tract communities",
      features: [
        "AI Symptom Checker",
        "Emergency Detection",
    ...
    BN: {
      ...
      appName: "ShasthoBondhu AI",
      appDescription:
        "গ্রামীণ ও পাহাড়ি এলাকার জন্য AI-চালিত স্বাস্থ্যসেবা প্ল্যাটফর্ম",
      features: [
        "AI লক্ষণ পরীক্ষক",
      ...
      <div className="relative z-10 flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="lg:w-1/2 flex items-center justify-center p-8 lg:p-16">
          <div className="w-full max-w-lg">
            {authMode === "login" ? (
              <LoginForm onToggleMode={toggleAuthMode} language={language} />
            ) : (
              <RegisterForm onToggleMode={toggleAuthMode} language={language} />
            )}
          </div>
        </div>
      </div>
